...
class UnitreeG1Config:
    ...
    wbc_repo: str = "/home/unitree/jimmy/wbc_pico_record"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--wbc-repo", default="/home/unitree/jimmy/wbc_pico_record", help="Path to the teleop/WBC repo to reuse.")
